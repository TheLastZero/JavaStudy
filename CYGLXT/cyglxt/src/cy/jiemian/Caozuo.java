...
public class Caozuo extends JFrame implements ActionListener,MouseListener
{
	...
	public void initAllPanel()
	{
		...
		jp1_lab3=new JLabel("登 陆 管 理",new ImageIcon("image/label_3.jpg"),0);
		...
		jp1_lab4=new JLabel("菜 谱 价 格",new ImageIcon("image/label_4.jpg"),0);
		...
		jp1_lab5=new JLabel("报 表 统 计",new ImageIcon("image/label_5.jpg"),0);
		...
		jp1_lab7=new JLabel("系 统 设 置",new ImageIcon("image/label_7.jpg"),0);
		...
		jp1_lab8=new JLabel("动 画 帮 助",new ImageIcon("image/label_8.jpg"),0);
